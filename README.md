...
- **📖 Оружие** — справка: какое оружие под какой калибр (таблица + список
  калибров).
- **🔦 Фонарик** — эмулятор: включаешь — заряд тратится со временем; когда сел,
  «Перезарядить» забирает одну батарейку из инвентаря. Время работы на заряд
  настраивается.
...
- **Инвентарь с весом:** у рюкзака — грузоподъёмность (кг), у каждого предмета
  свой вес; лист считает суммарный вес и подсвечивает **перегруз** (оружие в
  вес не входит).
- Спасброски, снаряжение, расходники, перки/мутации, репутация.
